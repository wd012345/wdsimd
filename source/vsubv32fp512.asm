; file:         vsubv32fp512.asm
;
; Assembly function that subtracts two 32bit floating point arrays with
...
; extern(C) void vsubv32fp512(ulong N, float* u, float* v, float* w);
;
; where
...
loop1:
  ...
  vsubps        zmm0,zmm0,[rdx+r8]
  vsubps        zmm1,zmm1,[rdx+r8+64]
  vsubps        zmm2,zmm2,[rdx+r8+128]
  vsubps        zmm3,zmm3,[rdx+r8+192]
  vsubps        zmm4,zmm4,[rdx+r8+256]
  vsubps        zmm5,zmm5,[rdx+r8+320]
  vsubps        zmm6,zmm6,[rdx+r8+384]
  vsubps        zmm7,zmm7,[rdx+r8+448]
  vsubps        zmm8,zmm8,[rdx+r8+512]
  vsubps        zmm9,zmm9,[rdx+r8+576]
  vsubps        zmm10,zmm10,[rdx+r8+640]
  vsubps        zmm11,zmm11,[rdx+r8+704]
  vsubps        zmm12,zmm12,[rdx+r8+768]
  vsubps        zmm13,zmm13,[rdx+r8+832]
  vsubps        zmm14,zmm14,[rdx+r8+896]
  vsubps        zmm15,zmm15,[rdx+r8+960]
  vsubps        zmm16,zmm16,[rdx+r8+1024]
  vsubps        zmm17,zmm17,[rdx+r8+1088]
  vsubps        zmm18,zmm18,[rdx+r8+1152]
  vsubps        zmm19,zmm19,[rdx+r8+1216]
  vsubps        zmm20,zmm20,[rdx+r8+1280]
  vsubps        zmm21,zmm21,[rdx+r8+1344]
  vsubps        zmm22,zmm22,[rdx+r8+1408]
  vsubps        zmm23,zmm23,[rdx+r8+1472]
  vsubps        zmm24,zmm24,[rdx+r8+1536]
  vsubps        zmm25,zmm25,[rdx+r8+1600]
  vsubps        zmm26,zmm26,[rdx+r8+1664]
  vsubps        zmm27,zmm27,[rdx+r8+1728]
  vsubps        zmm28,zmm28,[rdx+r8+1792]
  vsubps        zmm29,zmm29,[rdx+r8+1856]
  vsubps        zmm30,zmm30,[rdx+r8+1920]
  vsubps        zmm31,zmm31,[rdx+r8+1984]
  vmovaps       [rcx+r8],zmm0
...
loop2:
  ...
  vsubps        zmm0,zmm1,[rdx+r8]      ; process looped stage 1
...
loop3:
  ...
  vsubps        ymm0,ymm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  vsubps        xmm0,xmm1,[rdx+r8]      ; process looped stage 4
...
loop5:
  ...
  subss         xmm0,[rdx+r8]           ; process looped stage 5
