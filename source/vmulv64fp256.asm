; file:         vmulv64fp256.asm
;
; Assembly function that multiplies N 64 bit floating point components of two
; arrays according to
;     w_1 = u_1 * v_1
;     w_2 = u_2 * v_2
;           .
...
; extern(C) void vmulv64fp256(ulong N, double* u, double* v, double* w);
;
; where
...
loop1:
  ...
  vmulpd        ymm0,ymm0,[rdx+r8]
  vmulpd        ymm1,ymm1,[rdx+r8+32]
  vmulpd        ymm2,ymm2,[rdx+r8+64]
  vmulpd        ymm3,ymm3,[rdx+r8+96]
  vmulpd        ymm4,ymm4,[rdx+r8+128]
  vmulpd        ymm5,ymm5,[rdx+r8+160]
  vmulpd        ymm6,ymm6,[rdx+r8+192]
  vmulpd        ymm7,ymm7,[rdx+r8+224]
  vmulpd        ymm8,ymm8,[rdx+r8+256]
  vmulpd        ymm9,ymm9,[rdx+r8+288]
  vmulpd        ymm10,ymm10,[rdx+r8+320]
  vmulpd        ymm11,ymm11,[rdx+r8+352]
  vmulpd        ymm12,ymm12,[rdx+r8+384]
  vmulpd        ymm13,ymm13,[rdx+r8+416]
  vmulpd        ymm14,ymm14,[rdx+r8+448]
  vmovapd       [rcx+r8],ymm0
...
loop2:
  ...
  vmulpd        ymm0,ymm1,[rdx+r8]      ; process looped stage 2
...
loop3:
  ...
  vmulpd        xmm0,xmm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  mulsd         xmm0,[rdx+r8]           ; process looped stage 4
