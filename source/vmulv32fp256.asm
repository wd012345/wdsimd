; file:         vmulv32fp256.asm
;
; Assembly function that multiplies N 32 bit floating point components of two
; arrays according to
;     w_1 = u_1 * v_1
;     w_2 = u_2 * v_2
;           .
...
; extern(C) void vmulv32fp256(ulong N, float* u, float* v, float* w);
;
; where
...
loop1:
  ...
  vmulps        ymm0,ymm0,[rdx+r8]
  vmulps        ymm1,ymm1,[rdx+r8+32]
  vmulps        ymm2,ymm2,[rdx+r8+64]
  vmulps        ymm3,ymm3,[rdx+r8+96]
  vmulps        ymm4,ymm4,[rdx+r8+128]
  vmulps        ymm5,ymm5,[rdx+r8+160]
  vmulps        ymm6,ymm6,[rdx+r8+192]
  vmulps        ymm7,ymm7,[rdx+r8+224]
  vmulps        ymm8,ymm8,[rdx+r8+256]
  vmulps        ymm9,ymm9,[rdx+r8+288]
  vmulps        ymm10,ymm10,[rdx+r8+320]
  vmulps        ymm11,ymm11,[rdx+r8+352]
  vmulps        ymm12,ymm12,[rdx+r8+384]
  vmulps        ymm13,ymm13,[rdx+r8+416]
  vmulps        ymm14,ymm14,[rdx+r8+448]
  vmovaps       [rcx+r8],ymm0
...
loop2:
  ...
  vmulps        ymm0,ymm1,[rdx+r8]      ; process looped stage 2
...
loop3:
  ...
  vmulps        xmm0,xmm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  mulss         xmm0,[rdx+r8]           ; process looped stage 4
