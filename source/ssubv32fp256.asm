...
; extern(C) void ssubv32fp256(ulong N, float s, float* v, float* w);
;
; where
...
loop1:
  vsubps        ymm0,ymm15,[rsi+r8]
  vsubps        ymm1,ymm15,[rsi+r8+32]
  vsubps        ymm2,ymm15,[rsi+r8+64]
  vsubps        ymm3,ymm15,[rsi+r8+96]
  vsubps        ymm4,ymm15,[rsi+r8+128]
  vsubps        ymm5,ymm15,[rsi+r8+160]
  vsubps        ymm6,ymm15,[rsi+r8+192]
  vsubps        ymm7,ymm15,[rsi+r8+224]
  vsubps        ymm8,ymm15,[rsi+r8+256]
  vsubps        ymm9,ymm15,[rsi+r8+288]
  vsubps        ymm10,ymm15,[rsi+r8+320]
  vsubps        ymm11,ymm15,[rsi+r8+352]
  vsubps        ymm12,ymm15,[rsi+r8+384]
  vsubps        ymm13,ymm15,[rsi+r8+416]
  vsubps        ymm14,ymm15,[rsi+r8+448]
  vmovaps       [rdx+r8],ymm0
...
loop2:
  vsubps        ymm0,ymm15,[rsi+r8]     ; process looped stage 2
...
loop3:
  vsubps        xmm0,xmm15,[rsi+r8]     ; process looped stage 3
...
loop4:
  vsubss        xmm0,xmm15,[rsi+r8]     ; process looped stage 4
