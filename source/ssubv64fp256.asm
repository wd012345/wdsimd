...
; extern(C) void ssubv64fp256(ulong N, double s, double* v, double* w);
;
; where
...
loop1:
  vsubpd        ymm0,ymm15,[rsi+r8]
  vsubpd        ymm1,ymm15,[rsi+r8+32]
  vsubpd        ymm2,ymm15,[rsi+r8+64]
  vsubpd        ymm3,ymm15,[rsi+r8+96]
  vsubpd        ymm4,ymm15,[rsi+r8+128]
  vsubpd        ymm5,ymm15,[rsi+r8+160]
  vsubpd        ymm6,ymm15,[rsi+r8+192]
  vsubpd        ymm7,ymm15,[rsi+r8+224]
  vsubpd        ymm8,ymm15,[rsi+r8+256]
  vsubpd        ymm9,ymm15,[rsi+r8+288]
  vsubpd        ymm10,ymm15,[rsi+r8+320]
  vsubpd        ymm11,ymm15,[rsi+r8+352]
  vsubpd        ymm12,ymm15,[rsi+r8+384]
  vsubpd        ymm13,ymm15,[rsi+r8+416]
  vsubpd        ymm14,ymm15,[rsi+r8+448]
  vmovapd       [rdx+r8],ymm0
...
loop2:
  vsubpd        ymm0,ymm15,[rsi+r8]     ; process looped stage 2
...
loop3:
  vsubpd        xmm0,xmm15,[rsi+r8]     ; process looped stage 3
...
loop4:
  vsubsd        xmm0,xmm15,[rsi+r8]     ; process looped stage 4
