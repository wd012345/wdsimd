; file:         vsubv64fp256.asm
;
; Assembly function that subtracts N 64 bit floating point array components
; according to
;     w_1 = u_1 - v_1
;     w_2 = u_2 - v_2
;           .
...
; extern(C) void vsubv64fp256(ulong N, double* u, double* v, double* w);
;
; where
...
loop1:
  ...
  vsubpd        ymm2,ymm2,[rdx+r8+64]
  vsubpd        ymm3,ymm3,[rdx+r8+96]
  vsubpd        ymm4,ymm4,[rdx+r8+128]
  vsubpd        ymm5,ymm5,[rdx+r8+160]
  vsubpd        ymm6,ymm6,[rdx+r8+192]
  vsubpd        ymm7,ymm7,[rdx+r8+224]
  vsubpd        ymm8,ymm8,[rdx+r8+256]
  vsubpd        ymm9,ymm9,[rdx+r8+288]
  vsubpd        ymm10,ymm10,[rdx+r8+320]
  vsubpd        ymm11,ymm11,[rdx+r8+352]
  vsubpd        ymm12,ymm12,[rdx+r8+384]
  vsubpd        ymm13,ymm13,[rdx+r8+416]
  vsubpd        ymm14,ymm14,[rdx+r8+448]
  vmovapd       [rcx+r8],ymm0
...
loop2:
  ...
  vsubpd        ymm0,ymm1,[rdx+r8]      ; process looped stage 2
...
loop3:
  ...
  vsubpd        xmm0,xmm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  subsd         xmm0,[rdx+r8]           ; process looped stage 4
