...
; extern(C) void vsubv32fp256(ulong N, float* u, float* v, float* w);
;
; where
...
loop1:
  ...
  vsubps        ymm0,ymm0,[rdx+r8]
  vsubps        ymm1,ymm1,[rdx+r8+32]
  vsubps        ymm2,ymm2,[rdx+r8+64]
  vsubps        ymm3,ymm3,[rdx+r8+96]
  vsubps        ymm4,ymm4,[rdx+r8+128]
  vsubps        ymm5,ymm5,[rdx+r8+160]
  vsubps        ymm6,ymm6,[rdx+r8+192]
  vsubps        ymm7,ymm7,[rdx+r8+224]
  vsubps        ymm8,ymm8,[rdx+r8+256]
  vsubps        ymm9,ymm9,[rdx+r8+288]
  vsubps        ymm10,ymm10,[rdx+r8+320]
  vsubps        ymm11,ymm11,[rdx+r8+352]
  vsubps        ymm12,ymm12,[rdx+r8+384]
  vsubps        ymm13,ymm13,[rdx+r8+416]
  vsubps        ymm14,ymm14,[rdx+r8+448]
  vmovaps       [rcx+r8],ymm0
...
loop2:
  ...
  vsubps        ymm0,ymm1,[rdx+r8]      ; process looped stage 2
...
loop3:
  ...
  vsubps        xmm0,xmm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  subss         xmm0,[rdx+r8]           ; process looped stage 4
