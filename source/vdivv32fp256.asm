; file:         vdivv32fp256.asm
;
; Assembly function that divides N 32 bit floating point components of two
; arrays according to
;     w_1 = u_1 / v_1
;     w_2 = u_2 / v_2
;           .
...
; extern(C) void vdivv32fp256(ulong N, float* u, float* v, float* w);
;
; where
...
loop1:
  ...
  vdivps        ymm0,ymm0,[rdx+r8]
  vdivps        ymm1,ymm1,[rdx+r8+32]
  vdivps        ymm2,ymm2,[rdx+r8+64]
  vdivps        ymm3,ymm3,[rdx+r8+96]
  vdivps        ymm4,ymm4,[rdx+r8+128]
  vdivps        ymm5,ymm5,[rdx+r8+160]
  vdivps        ymm6,ymm6,[rdx+r8+192]
  vdivps        ymm7,ymm7,[rdx+r8+224]
  vdivps        ymm8,ymm8,[rdx+r8+256]
  vdivps        ymm9,ymm9,[rdx+r8+288]
  vdivps        ymm10,ymm10,[rdx+r8+320]
  vdivps        ymm11,ymm11,[rdx+r8+352]
  vdivps        ymm12,ymm12,[rdx+r8+384]
  vdivps        ymm13,ymm13,[rdx+r8+416]
  vdivps        ymm14,ymm14,[rdx+r8+448]
  vmovaps       [rcx+r8],ymm0
...
loop2:
  ...
  vdivps        ymm0,ymm1,[rdx+r8]      ; process looped stage 2
...
loop3:
  ...
  vdivps        xmm0,xmm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  divss         xmm0,[rdx+r8]           ; process looped stage 4
