; file:         vsubv64fp512.asm
;
; Assembly function that subtracts two 64bit floating point arrays with
...
; extern(C) void vsubv64fp512(ulong N, double* u, double* v, double* w);
;
; where
...
loop1:
  ...
  vsubpd        zmm0,zmm0,[rdx+r8]
  vsubpd        zmm1,zmm1,[rdx+r8+64]
  vsubpd        zmm2,zmm2,[rdx+r8+128]
  vsubpd        zmm3,zmm3,[rdx+r8+192]
  vsubpd        zmm4,zmm4,[rdx+r8+256]
  vsubpd        zmm5,zmm5,[rdx+r8+320]
  vsubpd        zmm6,zmm6,[rdx+r8+384]
  vsubpd        zmm7,zmm7,[rdx+r8+448]
  vsubpd        zmm8,zmm8,[rdx+r8+512]
  vsubpd        zmm9,zmm9,[rdx+r8+576]
  vsubpd        zmm10,zmm10,[rdx+r8+640]
  vsubpd        zmm11,zmm11,[rdx+r8+704]
  vsubpd        zmm12,zmm12,[rdx+r8+768]
  vsubpd        zmm13,zmm13,[rdx+r8+832]
  vsubpd        zmm14,zmm14,[rdx+r8+896]
  vsubpd        zmm15,zmm15,[rdx+r8+960]
  vsubpd        zmm16,zmm16,[rdx+r8+1024]
  vsubpd        zmm17,zmm17,[rdx+r8+1088]
  vsubpd        zmm18,zmm18,[rdx+r8+1152]
  vsubpd        zmm19,zmm19,[rdx+r8+1216]
  vsubpd        zmm20,zmm20,[rdx+r8+1280]
  vsubpd        zmm21,zmm21,[rdx+r8+1344]
  vsubpd        zmm22,zmm22,[rdx+r8+1408]
  vsubpd        zmm23,zmm23,[rdx+r8+1472]
  vsubpd        zmm24,zmm24,[rdx+r8+1536]
  vsubpd        zmm25,zmm25,[rdx+r8+1600]
  vsubpd        zmm26,zmm26,[rdx+r8+1664]
  vsubpd        zmm27,zmm27,[rdx+r8+1728]
  vsubpd        zmm28,zmm28,[rdx+r8+1792]
  vsubpd        zmm29,zmm29,[rdx+r8+1856]
  vsubpd        zmm30,zmm30,[rdx+r8+1920]
  vsubpd        zmm31,zmm31,[rdx+r8+1984]
  vmovapd       [rcx+r8],zmm0
...
loop2:
  ...
  vsubpd        zmm0,zmm1,[rdx+r8]      ; process looped stage 1
...
loop3:
  ...
  vsubpd        ymm0,ymm1,[rsi+r8]      ; process looped stage 3
...
loop4:
  ...
  vsubpd        xmm0,xmm1,[rdx+r8]      ; process looped stage 4
...
loop5:
  ...
  subsd         xmm0,[rdx+r8]           ; process looped stage 5
