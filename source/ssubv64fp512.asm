; file:         ssubv64fp512.asm
;
; Assembly function that subtracts N 64bit floating point array components
; from a 64bit floating point scalar according to
;     w_{111...} = s - v_{111...}
;     w_{211...} = s - v_{211...}
;           .
;           .
...
; extern(C) void ssubv64fp512(ulong N, double s, double* v, double* w);
;
; where
...
loop1:
  vsubpd        zmm0,zmm31,[rsi+r8]
  vsubpd        zmm1,zmm31,[rsi+r8+64]
  vsubpd        zmm2,zmm31,[rsi+r8+128]
  vsubpd        zmm3,zmm31,[rsi+r8+192]
  vsubpd        zmm4,zmm31,[rsi+r8+256]
  vsubpd        zmm5,zmm31,[rsi+r8+320]
  vsubpd        zmm6,zmm31,[rsi+r8+384]
  vsubpd        zmm7,zmm31,[rsi+r8+448]
  vsubpd        zmm8,zmm31,[rsi+r8+512]
  vsubpd        zmm9,zmm31,[rsi+r8+576]
  vsubpd        zmm10,zmm31,[rsi+r8+640]
  vsubpd        zmm11,zmm31,[rsi+r8+704]
  vsubpd        zmm12,zmm31,[rsi+r8+768]
  vsubpd        zmm13,zmm31,[rsi+r8+832]
  vsubpd        zmm14,zmm31,[rsi+r8+896]
  vsubpd        zmm15,zmm31,[rsi+r8+960]
  vsubpd        zmm16,zmm31,[rsi+r8+1024]
  vsubpd        zmm17,zmm31,[rsi+r8+1088]
  vsubpd        zmm18,zmm31,[rsi+r8+1152]
  vsubpd        zmm19,zmm31,[rsi+r8+1216]
  vsubpd        zmm20,zmm31,[rsi+r8+1280]
  vsubpd        zmm21,zmm31,[rsi+r8+1344]
  vsubpd        zmm22,zmm31,[rsi+r8+1408]
  vsubpd        zmm23,zmm31,[rsi+r8+1472]
  vsubpd        zmm24,zmm31,[rsi+r8+1536]
  vsubpd        zmm25,zmm31,[rsi+r8+1600]
  vsubpd        zmm26,zmm31,[rsi+r8+1664]
  vsubpd        zmm27,zmm31,[rsi+r8+1728]
  vsubpd        zmm28,zmm31,[rsi+r8+1792]
  vsubpd        zmm29,zmm31,[rsi+r8+1856]
  vsubpd        zmm30,zmm31,[rsi+r8+1920]
  vmovapd       [rdx+r8],zmm0
...
loop2:
  vsubpd        zmm0,zmm31,[rsi+r8]     ; process looped stage 1
...
loop3:
  vsubpd        ymm0,ymm31,[rsi+r8]     ; process looped stage 3
...
loop4:
  vsubpd        xmm0,xmm31,[rsi+r8]     ; process looped stage 4
...
loop5:
  vsubsd        xmm0,xmm31,[rsi+r8]     ; process looped stage 5
