...
; extern(C) void vdivs32fp256(ulong N, float* u, float s, float* w);
;
; where
...
loop1:
  ...
  vdivps        ymm8,ymm8,ymm15
  vdivps        ymm9,ymm9,ymm15
  vdivps        ymm10,ymm10,ymm15
  vdivps        ymm11,ymm11,ymm15
  vdivps        ymm12,ymm12,ymm15
  vdivps        ymm13,ymm13,ymm15
  vdivps        ymm14,ymm14,ymm15
  vmovaps       [rdx+r8],ymm0
...
loop2:
  ...
  vdivps        ymm0,ymm1,ymm15         ; process looped stage 2
...
loop3:
  ...
  vdivps        xmm0,xmm1,xmm15         ; process looped stage 3
...
loop4:
  ...
  vdivss        xmm0,xmm1,xmm15         ; process looped stage 4
