; file:         vaddv32fp512.asm
;
; Assembly function that adds two 32bit floating point arrays with
...
; extern(C) void vaddv32fp512(ulong N, float* u, float* v, float* w);
;
; where
...
loop1:
  ...
  vaddps        zmm0,zmm0,[rdx+r8]
  vaddps        zmm1,zmm1,[rdx+r8+64]
  vaddps        zmm2,zmm2,[rdx+r8+128]
  vaddps        zmm3,zmm3,[rdx+r8+192]
  vaddps        zmm4,zmm4,[rdx+r8+256]
  vaddps        zmm5,zmm5,[rdx+r8+320]
  vaddps        zmm6,zmm6,[rdx+r8+384]
  vaddps        zmm7,zmm7,[rdx+r8+448]
  vaddps        zmm8,zmm8,[rdx+r8+512]
  vaddps        zmm9,zmm9,[rdx+r8+576]
  vaddps        zmm10,zmm10,[rdx+r8+640]
  vaddps        zmm11,zmm11,[rdx+r8+704]
  vaddps        zmm12,zmm12,[rdx+r8+768]
  vaddps        zmm13,zmm13,[rdx+r8+832]
  vaddps        zmm14,zmm14,[rdx+r8+896]
  vaddps        zmm15,zmm15,[rdx+r8+960]
  vaddps        zmm16,zmm16,[rdx+r8+1024]
  vaddps        zmm17,zmm17,[rdx+r8+1088]
  vaddps        zmm18,zmm18,[rdx+r8+1152]
  vaddps        zmm19,zmm19,[rdx+r8+1216]
  vaddps        zmm20,zmm20,[rdx+r8+1280]
  vaddps        zmm21,zmm21,[rdx+r8+1344]
  vaddps        zmm22,zmm22,[rdx+r8+1408]
  vaddps        zmm23,zmm23,[rdx+r8+1472]
  vaddps        zmm24,zmm24,[rdx+r8+1536]
  vaddps        zmm25,zmm25,[rdx+r8+1600]
  vaddps        zmm26,zmm26,[rdx+r8+1664]
  vaddps        zmm27,zmm27,[rdx+r8+1728]
  vaddps        zmm28,zmm28,[rdx+r8+1792]
  vaddps        zmm29,zmm29,[rdx+r8+1856]
  vaddps        zmm30,zmm30,[rdx+r8+1920]
  vaddps        zmm31,zmm31,[rdx+r8+1984]
  vmovaps       [rcx+r8],zmm0
...
loop2:
  ...
  vaddps        zmm0,zmm1,[rdx+r8]      ; process looped stage 1
...
loop3:
  ...
  vaddps        ymm0,ymm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  vaddps        xmm0,xmm1,[rdx+r8]      ; process looped stage 4
...
loop5:
  ...
  addss         xmm0,[rdx+r8]           ; process looped stage 5
