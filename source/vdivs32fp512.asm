; file:         vdivs32fp512.asm
;
; Assembly function that divides N 32bit floating point array components
; by a 32bit floating point scalar according to
;     w_{111...} = u_{111...} / s
;     w_{211...} = u_{211...} / s
;           .
;           .
...
; extern(C) void vdivs32fp512(ulong N, float* u, float s, float* w);
;
; where
...
loop1:
  vdivps        zmm0,zmm31,[rsi+r8]
  vdivps        zmm1,zmm31,[rsi+r8+64]
  vdivps        zmm2,zmm31,[rsi+r8+128]
  vdivps        zmm3,zmm31,[rsi+r8+192]
  vdivps        zmm4,zmm31,[rsi+r8+256]
  vdivps        zmm5,zmm31,[rsi+r8+320]
  vdivps        zmm6,zmm31,[rsi+r8+384]
  vdivps        zmm7,zmm31,[rsi+r8+448]
  vdivps        zmm8,zmm31,[rsi+r8+512]
  vdivps        zmm9,zmm31,[rsi+r8+576]
  vdivps        zmm10,zmm31,[rsi+r8+640]
  vdivps        zmm11,zmm31,[rsi+r8+704]
  vdivps        zmm12,zmm31,[rsi+r8+768]
  vdivps        zmm13,zmm31,[rsi+r8+832]
  vdivps        zmm14,zmm31,[rsi+r8+896]
  vdivps        zmm15,zmm31,[rsi+r8+960]
  vdivps        zmm16,zmm31,[rsi+r8+1024]
  vdivps        zmm17,zmm31,[rsi+r8+1088]
  vdivps        zmm18,zmm31,[rsi+r8+1152]
  vdivps        zmm19,zmm31,[rsi+r8+1216]
  vdivps        zmm20,zmm31,[rsi+r8+1280]
  vdivps        zmm21,zmm31,[rsi+r8+1344]
  vdivps        zmm22,zmm31,[rsi+r8+1408]
  vdivps        zmm23,zmm31,[rsi+r8+1472]
  vdivps        zmm24,zmm31,[rsi+r8+1536]
  vdivps        zmm25,zmm31,[rsi+r8+1600]
  vdivps        zmm26,zmm31,[rsi+r8+1664]
  vdivps        zmm27,zmm31,[rsi+r8+1728]
  vdivps        zmm28,zmm31,[rsi+r8+1792]
  vdivps        zmm29,zmm31,[rsi+r8+1856]
  vdivps        zmm30,zmm31,[rsi+r8+1920]
  vmovaps       [rdx+r8],zmm0
...
loop2:
  vdivps        zmm0,zmm31,[rsi+r8]     ; process looped stage 1
...
loop3:
  vdivps        ymm0,ymm31,[rsi+r8]     ; process looped stage 3
...
loop4:
  vdivps        xmm0,xmm31,[rsi+r8]     ; process looped stage 4
...
loop5:
  vdivss        xmm0,xmm31,[rsi+r8]     ; process looped stage 5
