; file:         vaddv64fp256.asm
;
; Assembly function that adds N 64 bit floating point components of two
; arrays according to
;     w_1 = u_1 + v_1
;     w_2 = u_2 + v_2
;           .
...
; extern(C) void vaddv64fp256(ulong N, double* u, double* v, double* w);
;
; where
...
loop1:
  ...
  vaddpd        ymm2,ymm2,[rdx+r8+64]
  vaddpd        ymm3,ymm3,[rdx+r8+96]
  vaddpd        ymm4,ymm4,[rdx+r8+128]
  vaddpd        ymm5,ymm5,[rdx+r8+160]
  vaddpd        ymm6,ymm6,[rdx+r8+192]
  vaddpd        ymm7,ymm7,[rdx+r8+224]
  vaddpd        ymm8,ymm8,[rdx+r8+256]
  vaddpd        ymm9,ymm9,[rdx+r8+288]
  vaddpd        ymm10,ymm10,[rdx+r8+320]
  vaddpd        ymm11,ymm11,[rdx+r8+352]
  vaddpd        ymm12,ymm12,[rdx+r8+384]
  vaddpd        ymm13,ymm13,[rdx+r8+416]
  vaddpd        ymm14,ymm14,[rdx+r8+448]
  vmovapd       [rcx+r8],ymm0
...
loop2:
  ...
  vaddpd        ymm0,ymm1,[rdx+r8]      ; process looped stage 2
...
loop3:
  ...
  vaddpd        xmm0,xmm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  addsd         xmm0,[rdx+r8]           ; process looped stage 4
