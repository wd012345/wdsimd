; file:         vmuls64fp256.asm
;
; Assembly function that multiplies N 64bit floating point array components
; with a 64bit floating point scalar according to
;     w_{111...} = u_{111...} * s
;     w_{211...} = u_{211...} * s
;           .
;           .
...
; extern(C) void vmuls64fp256(ulong N, double* u, double s, double* w);
;
; where
...
loop1:
  vmulpd        ymm0,ymm15,[rsi+r8]
  vmulpd        ymm1,ymm15,[rsi+r8+32]
  vmulpd        ymm2,ymm15,[rsi+r8+64]
  vmulpd        ymm3,ymm15,[rsi+r8+96]
  vmulpd        ymm4,ymm15,[rsi+r8+128]
  vmulpd        ymm5,ymm15,[rsi+r8+160]
  vmulpd        ymm6,ymm15,[rsi+r8+192]
  vmulpd        ymm7,ymm15,[rsi+r8+224]
  vmulpd        ymm8,ymm15,[rsi+r8+256]
  vmulpd        ymm9,ymm15,[rsi+r8+288]
  vmulpd        ymm10,ymm15,[rsi+r8+320]
  vmulpd        ymm11,ymm15,[rsi+r8+352]
  vmulpd        ymm12,ymm15,[rsi+r8+384]
  vmulpd        ymm13,ymm15,[rsi+r8+416]
  vmulpd        ymm14,ymm15,[rsi+r8+448]
  vmovapd       [rdx+r8],ymm0
...
loop2:
  vmulpd        ymm0,ymm15,[rsi+r8]     ; process looped stage 2
...
loop3:
  vmulpd        xmm0,xmm15,[rsi+r8]     ; process looped stage 3
...
loop4:
  vmulsd        xmm0,xmm15,[rsi+r8]     ; process looped stage 4
