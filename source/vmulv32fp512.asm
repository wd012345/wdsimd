...
;
; Assembly function that multiplies two 32bit floating point arrays with
...
; extern(C) void vmulv32fp512(ulong N, float* u, float* v, float* w);
;
; where
...
loop1:
  ...
  vmulps        zmm0,zmm0,[rdx+r8]
  vmulps        zmm1,zmm1,[rdx+r8+64]
  vmulps        zmm2,zmm2,[rdx+r8+128]
  vmulps        zmm3,zmm3,[rdx+r8+192]
  vmulps        zmm4,zmm4,[rdx+r8+256]
  vmulps        zmm5,zmm5,[rdx+r8+320]
  vmulps        zmm6,zmm6,[rdx+r8+384]
  vmulps        zmm7,zmm7,[rdx+r8+448]
  vmulps        zmm8,zmm8,[rdx+r8+512]
  vmulps        zmm9,zmm9,[rdx+r8+576]
  vmulps        zmm10,zmm10,[rdx+r8+640]
  vmulps        zmm11,zmm11,[rdx+r8+704]
  vmulps        zmm12,zmm12,[rdx+r8+768]
  vmulps        zmm13,zmm13,[rdx+r8+832]
  vmulps        zmm14,zmm14,[rdx+r8+896]
  vmulps        zmm15,zmm15,[rdx+r8+960]
  vmulps        zmm16,zmm16,[rdx+r8+1024]
  vmulps        zmm17,zmm17,[rdx+r8+1088]
  vmulps        zmm18,zmm18,[rdx+r8+1152]
  vmulps        zmm19,zmm19,[rdx+r8+1216]
  vmulps        zmm20,zmm20,[rdx+r8+1280]
  vmulps        zmm21,zmm21,[rdx+r8+1344]
  vmulps        zmm22,zmm22,[rdx+r8+1408]
  vmulps        zmm23,zmm23,[rdx+r8+1472]
  vmulps        zmm24,zmm24,[rdx+r8+1536]
  vmulps        zmm25,zmm25,[rdx+r8+1600]
  vmulps        zmm26,zmm26,[rdx+r8+1664]
  vmulps        zmm27,zmm27,[rdx+r8+1728]
  vmulps        zmm28,zmm28,[rdx+r8+1792]
  vmulps        zmm29,zmm29,[rdx+r8+1856]
  vmulps        zmm30,zmm30,[rdx+r8+1920]
  vmulps        zmm31,zmm31,[rdx+r8+1984]
  vmovaps       [rcx+r8],zmm0
...
loop2:
  ...
  vmulps        zmm0,zmm1,[rdx+r8]      ; process looped stage 1
...
loop3:
  ...
  vmulps        ymm0,ymm1,[rdx+r8]      ; process looped stage 3
...
loop4:
  ...
  vmulps        xmm0,xmm1,[rdx+r8]      ; process looped stage 4
...
loop5:
  ...
  mulss         xmm0,[rdx+r8]           ; process looped stage 5
