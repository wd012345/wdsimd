...
;
; Assembly function that adds two 64bit floating point arrays with
...
; extern(C) void vadds64fp512(ulong N, double* u, double* v, double* w);
;
; where
...
loop1:
  ...
  vaddpd        zmm0,zmm0,[rdx+r8]
  vaddpd        zmm1,zmm1,[rdx+r8+64]
  vaddpd        zmm2,zmm2,[rdx+r8+128]
  vaddpd        zmm3,zmm3,[rdx+r8+192]
  vaddpd        zmm4,zmm4,[rdx+r8+256]
  vaddpd        zmm5,zmm5,[rdx+r8+320]
  vaddpd        zmm6,zmm6,[rdx+r8+384]
  vaddpd        zmm7,zmm7,[rdx+r8+448]
  vaddpd        zmm8,zmm8,[rdx+r8+512]
  vaddpd        zmm9,zmm9,[rdx+r8+576]
  vaddpd        zmm10,zmm10,[rdx+r8+640]
  vaddpd        zmm11,zmm11,[rdx+r8+704]
  vaddpd        zmm12,zmm12,[rdx+r8+768]
  vaddpd        zmm13,zmm13,[rdx+r8+832]
  vaddpd        zmm14,zmm14,[rdx+r8+896]
  vaddpd        zmm15,zmm15,[rdx+r8+960]
  vaddpd        zmm16,zmm16,[rdx+r8+1024]
  vaddpd        zmm17,zmm17,[rdx+r8+1088]
  vaddpd        zmm18,zmm18,[rdx+r8+1152]
  vaddpd        zmm19,zmm19,[rdx+r8+1216]
  vaddpd        zmm20,zmm20,[rdx+r8+1280]
  vaddpd        zmm21,zmm21,[rdx+r8+1344]
  vaddpd        zmm22,zmm22,[rdx+r8+1408]
  vaddpd        zmm23,zmm23,[rdx+r8+1472]
  vaddpd        zmm24,zmm24,[rdx+r8+1536]
  vaddpd        zmm25,zmm25,[rdx+r8+1600]
  vaddpd        zmm26,zmm26,[rdx+r8+1664]
  vaddpd        zmm27,zmm27,[rdx+r8+1728]
  vaddpd        zmm28,zmm28,[rdx+r8+1792]
  vaddpd        zmm29,zmm29,[rdx+r8+1856]
  vaddpd        zmm30,zmm30,[rdx+r8+1920]
  vaddpd        zmm31,zmm31,[rdx+r8+1984]
  vmovapd       [rcx+r8],zmm0
...
loop2:
  ...
  vaddpd        zmm0,zmm1,[rdx+r8]      ; process looped stage 1
...
loop3:
  ...
  vaddpd        ymm0,ymm1,[rsi+r8]      ; process looped stage 3
...
loop4:
  ...
  vaddpd        xmm0,xmm1,[rdx+r8]      ; process looped stage 4
...
loop5:
  ...
  addsd         xmm0,[rdx+r8]           ; process looped stage 5
