; file:         vsubs64fp512.asm
;
; Assembly function that subtracts a 64bit floating point scalar from
...
; extern(C) void vsubs64fp512(ulong N, double* u, double s, double* w);
;
; where
