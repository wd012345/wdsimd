; file:         vsubs64fp256.asm
;
; Assembly function that subtracts from N 64bit floating point array
; components a64bit floating point scalar according to
;     w_{111...} = u_{111...} - s
;     w_{211...} = u_{211...} - s
;           .
;           .
...
; extern(C) void vsubs64fp256(ulong N, double* u, double s, double* w);
;
; where
...
loop4:
  ...
  subsd         xmm0,xmm15              ; process looped stage 4
