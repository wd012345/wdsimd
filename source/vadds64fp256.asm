...
; extern(C) void vadds64fp256(ulong N, double* u, double s, double* w);
;
; where
...
loop1:
  vaddpd        ymm0,ymm15,[rsi+r8]
  vaddpd        ymm1,ymm15,[rsi+r8+32]
  vaddpd        ymm2,ymm15,[rsi+r8+64]
  vaddpd        ymm3,ymm15,[rsi+r8+96]
  vaddpd        ymm4,ymm15,[rsi+r8+128]
  vaddpd        ymm5,ymm15,[rsi+r8+160]
  vaddpd        ymm6,ymm15,[rsi+r8+192]
  vaddpd        ymm7,ymm15,[rsi+r8+224]
  vaddpd        ymm8,ymm15,[rsi+r8+256]
  vaddpd        ymm9,ymm15,[rsi+r8+288]
  vaddpd        ymm10,ymm15,[rsi+r8+320]
  vaddpd        ymm11,ymm15,[rsi+r8+352]
  vaddpd        ymm12,ymm15,[rsi+r8+384]
  vaddpd        ymm13,ymm15,[rsi+r8+416]
  vaddpd        ymm14,ymm15,[rsi+r8+448]
  vmovapd       [rdx+r8],ymm0
...
loop2:
  vaddpd        ymm0,ymm15,[rsi+r8]     ; process looped stage 2
...
loop3:
  vaddpd        xmm0,xmm15,[rsi+r8]     ; process looped stage 3
...
loop4:
  vaddsd        xmm0,xmm15,[rsi+r8]     ; process looped stage 4
