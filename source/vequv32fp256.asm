...
; extern(C) void vequv32fp256(ulong N, float* u, float* w);
;
; where
...
loop2:
  vmovaps       ymm0,[rsi+r8]           ; process looped stage 2
...
loop3:
  vmovaps       xmm0,[rsi+r8]           ; process looped stage 3
...
loop4:
  movss         xmm0,[rsi+r8]           ; process looped stage 4
