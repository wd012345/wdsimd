...
; extern(C) void vadds32fp256(ulong N, float* u, float s, float* w);
;
; where
...
loop1:
  vaddps        ymm0,ymm15,[rsi+r8]
  vaddps        ymm1,ymm15,[rsi+r8+32]
  vaddps        ymm2,ymm15,[rsi+r8+64]
  vaddps        ymm3,ymm15,[rsi+r8+96]
  vaddps        ymm4,ymm15,[rsi+r8+128]
  vaddps        ymm5,ymm15,[rsi+r8+160]
  vaddps        ymm6,ymm15,[rsi+r8+192]
  vaddps        ymm7,ymm15,[rsi+r8+224]
  vaddps        ymm8,ymm15,[rsi+r8+256]
  vaddps        ymm9,ymm15,[rsi+r8+288]
  vaddps        ymm10,ymm15,[rsi+r8+320]
  vaddps        ymm11,ymm15,[rsi+r8+352]
  vaddps        ymm12,ymm15,[rsi+r8+384]
  vaddps        ymm13,ymm15,[rsi+r8+416]
  vaddps        ymm14,ymm15,[rsi+r8+448]
  vmovaps       [rdx+r8],ymm0
...
loop2:
  vaddps        ymm0,ymm15,[rsi+r8]     ; process looped stage 2
...
loop3:
  vaddps        xmm0,xmm15,[rsi+r8]     ; process looped stage 3
...
loop4:
  vaddss        xmm0,xmm15,[rsi+r8]     ; process looped stage 4
