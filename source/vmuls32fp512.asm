; file:         vmuls32fp512.asm
;
; Assembly function that multiplies a 32bit floating point scalar with
...
; extern(C) void vmuls32fp512(ulong N, float* u, float s, float* w);
;
; where
...
loop1:
  vmulps        zmm0,zmm31,[rsi+r8]
  vmulps        zmm1,zmm31,[rsi+r8+64]
  vmulps        zmm2,zmm31,[rsi+r8+128]
  vmulps        zmm3,zmm31,[rsi+r8+192]
  vmulps        zmm4,zmm31,[rsi+r8+256]
  vmulps        zmm5,zmm31,[rsi+r8+320]
  vmulps        zmm6,zmm31,[rsi+r8+384]
  vmulps        zmm7,zmm31,[rsi+r8+448]
  vmulps        zmm8,zmm31,[rsi+r8+512]
  vmulps        zmm9,zmm31,[rsi+r8+576]
  vmulps        zmm10,zmm31,[rsi+r8+640]
  vmulps        zmm11,zmm31,[rsi+r8+704]
  vmulps        zmm12,zmm31,[rsi+r8+768]
  vmulps        zmm13,zmm31,[rsi+r8+832]
  vmulps        zmm14,zmm31,[rsi+r8+896]
  vmulps        zmm15,zmm31,[rsi+r8+960]
  vmulps        zmm16,zmm31,[rsi+r8+1024]
  vmulps        zmm17,zmm31,[rsi+r8+1088]
  vmulps        zmm18,zmm31,[rsi+r8+1152]
  vmulps        zmm19,zmm31,[rsi+r8+1216]
  vmulps        zmm20,zmm31,[rsi+r8+1280]
  vmulps        zmm21,zmm31,[rsi+r8+1344]
  vmulps        zmm22,zmm31,[rsi+r8+1408]
  vmulps        zmm23,zmm31,[rsi+r8+1472]
  vmulps        zmm24,zmm31,[rsi+r8+1536]
  vmulps        zmm25,zmm31,[rsi+r8+1600]
  vmulps        zmm26,zmm31,[rsi+r8+1664]
  vmulps        zmm27,zmm31,[rsi+r8+1728]
  vmulps        zmm28,zmm31,[rsi+r8+1792]
  vmulps        zmm29,zmm31,[rsi+r8+1856]
  vmulps        zmm30,zmm31,[rsi+r8+1920]
  vmovaps       [rdx+r8],zmm0
...
loop2:
  vmulps        zmm0,zmm31,[rsi+r8]     ; process looped stage 1
...
loop3:
  vmulps        ymm0,ymm31,[rsi+r8]     ; process looped stage 3
...
loop4:
  vmulps        xmm0,xmm31,[rsi+r8]     ; process looped stage 4
...
loop5:
  vmulss        xmm0,xmm31,[rsi+r8]     ; process looped stage 5
