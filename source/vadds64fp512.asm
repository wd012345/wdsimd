; file:         vadds64fp512.asm
;
; Assembly function that adds a 64bit floating point scalar to
...
; extern(C) void vadds64fp512(ulong N, double* u, double s, double* w);
;
; where
...
loop1:
  vaddpd        zmm0,zmm31,[rsi+r8]
  vaddpd        zmm1,zmm31,[rsi+r8+64]
  vaddpd        zmm2,zmm31,[rsi+r8+128]
  vaddpd        zmm3,zmm31,[rsi+r8+192]
  vaddpd        zmm4,zmm31,[rsi+r8+256]
  vaddpd        zmm5,zmm31,[rsi+r8+320]
  vaddpd        zmm6,zmm31,[rsi+r8+384]
  vaddpd        zmm7,zmm31,[rsi+r8+448]
  vaddpd        zmm8,zmm31,[rsi+r8+512]
  vaddpd        zmm9,zmm31,[rsi+r8+576]
  vaddpd        zmm10,zmm31,[rsi+r8+640]
  vaddpd        zmm11,zmm31,[rsi+r8+704]
  vaddpd        zmm12,zmm31,[rsi+r8+768]
  vaddpd        zmm13,zmm31,[rsi+r8+832]
  vaddpd        zmm14,zmm31,[rsi+r8+896]
  vaddpd        zmm15,zmm31,[rsi+r8+960]
  vaddpd        zmm16,zmm31,[rsi+r8+1024]
  vaddpd        zmm17,zmm31,[rsi+r8+1088]
  vaddpd        zmm18,zmm31,[rsi+r8+1152]
  vaddpd        zmm19,zmm31,[rsi+r8+1216]
  vaddpd        zmm20,zmm31,[rsi+r8+1280]
  vaddpd        zmm21,zmm31,[rsi+r8+1344]
  vaddpd        zmm22,zmm31,[rsi+r8+1408]
  vaddpd        zmm23,zmm31,[rsi+r8+1472]
  vaddpd        zmm24,zmm31,[rsi+r8+1536]
  vaddpd        zmm25,zmm31,[rsi+r8+1600]
  vaddpd        zmm26,zmm31,[rsi+r8+1664]
  vaddpd        zmm27,zmm31,[rsi+r8+1728]
  vaddpd        zmm28,zmm31,[rsi+r8+1792]
  vaddpd        zmm29,zmm31,[rsi+r8+1856]
  vaddpd        zmm30,zmm31,[rsi+r8+1920]
  vmovapd       [rdx+r8],zmm0
...
loop2:
  vaddpd        zmm0,zmm31,[rsi+r8]     ; process looped stage 1
...
loop3:
  vaddpd        ymm0,ymm31,[rsi+r8]     ; process looped stage 3
...
loop4:
  vaddpd        xmm0,xmm31,[rsi+r8]     ; process looped stage 4
...
loop5:
  vaddsd        xmm0,xmm31,[rsi+r8]     ; process looped stage 5
