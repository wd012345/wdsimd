; file:         vsubs32fp512.asm
;
; Assembly function that subtracts a 32bit floating point scalar from
...
; extern(C) void vsubs32fp512(ulong N, float* u, float s, float* w);
;
; where
